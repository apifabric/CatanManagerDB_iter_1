...
resourcename="catanmanagerdbiter1"  # lower case, only
resourcegroup="catanmanagerdbiter1_rg"
...
# git clone https://github.com/apilogicserver/catanmanagerdbiter1.git
# cd catanmanagerdbiter1
...
az group create --name catanmanagerdbiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group catanmanagerdbiter1_rg --sku S1 --is-linux
az container create --resource-group catanmanagerdbiter1_rg --name catanmanagerdbiter1 --image apilogicserver/catanmanagerdbiter1:latest --dns-name-label catanmanagerdbiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//catanmanagerdbiter1.westus.azurecontainer.io:5656'
